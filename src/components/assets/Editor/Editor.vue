        ...
        <div class="editor-meta">
          <div class="asset-editor-meta-items">
            ...
            <div class="meta-item">
              ...
              <span class="meta-value" :title="asset.last_modified">{{
                asset.last_modified_relative
              }}</span>
            </div>
          </div>
          ...
          <div class="editor-preview">
            <div v-if="isImage" class="editor-preview-image">
              <div class="image-wrapper">
                <img :src="asset.preview" class="asset-thumb" alt="" />
              </div>
            </div>
            ...
            <div v-if="asset.extension === 'pdf'" class="full-height">
              <object
                :data="asset.url"
